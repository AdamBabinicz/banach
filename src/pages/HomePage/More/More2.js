    ...
    <HeroSection id="stefan-banach">
      <Row justify="center" align="center" height="100%" padding="2rem">
        <Column align="center" mb="10%">
          ...
          >
            <p>
              Nikodym był współzałożycielem Towarzystwa Matematycznego w
              Krakowie w 1919 r., które wkrótce przerodziło się w Polskie
              Towarzystwo Matematyczne. Był on bardzo wszechstronnym
              matematykiem. Interesował się twórczo logiką, teorią miary, teorią
              potencjału, analizą funkcjonalną, równaniami różniczkowymi
              cząstkowymi drugiego rzędu, matematycznymi metodami fizyki, teorią
              sieci, algebrą.
              <br />
              ...
              tensorów wraz z zastosowaniami do geometrii i fizyki
              matematycznej" (1938 r.), a także mający dwa wydania, napisany
              wspólnie z żoną Stanisławą "Wstęp do rachunku różniczkowego" (1936
              r. i IM47 r.) przeznaczony dla samokształcenia absolwentów szkół
              średnich i studentów pierwszych lat kierunków matematycznych.
              <br />
